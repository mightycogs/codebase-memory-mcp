...
// ==================== C# ====================
static const char* cs_func_types[] = {"destructor_declaration","local_function_statement","function_pointer_type","constructor_declaration","anonymous_method_expression","lambda_expression","method_declaration",NULL};
static const char* cs_class_types[] = {"class_declaration","struct_declaration","enum_declaration","interface_declaration",NULL};
...
static const char* cs_branch_types[] = {"if_statement","for_statement","foreach_statement","while_statement","switch_statement","case_switch_label","try_statement","catch_clause",NULL};
...
// ==================== PHP ====================
static const char* php_func_types[] = {"function_static_declaration","anonymous_function","function_definition","arrow_function","method_declaration",NULL};
static const char* php_class_types[] = {"trait_declaration","enum_declaration","interface_declaration","class_declaration",NULL};
static const char* php_module_types[] = {"program",NULL};
static const char* php_call_types[] = {"member_call_expression","scoped_call_expression","function_call_expression","nullsafe_member_call_expression",NULL};
static const char* php_branch_types[] = {"if_statement","for_statement","foreach_statement","while_statement","switch_statement","case_statement","try_statement","catch_clause",NULL};
...
static const char* scala_class_types[] = {"class_definition","object_definition","trait_definition",NULL};
static const char* scala_module_types[] = {"compilation_unit",NULL};
static const char* scala_call_types[] = {"call_expression","generic_function","field_expression","infix_expression",NULL};
static const char* scala_import_types[] = {"import_declaration",NULL};
static const char* scala_branch_types[] = {"if_expression","for_expression","while_expression","match_expression","case_clause","try_expression","catch_clause",NULL};
static const char* scala_var_types[] = {"val_definition","var_definition","val_declaration","var_declaration",NULL};
static const char* scala_assign_types[] = {"assignment_expression",NULL};
static const char* scala_throw_types[] = {"throw_expression",NULL};

// ==================== KOTLIN ====================
static const char* kotlin_func_types[] = {"function_declaration","secondary_constructor","anonymous_function",NULL};
static const char* kotlin_class_types[] = {"class_declaration","object_declaration","companion_object",NULL};
...
static const char* kotlin_branch_types[] = {"if_expression","for_statement","while_statement","when_expression","when_entry","try_expression","catch_block",NULL};
...
static const char* ruby_branch_types[] = {"if","unless","while","until","for","case","when","rescue","elsif",NULL};
...
static const char* zig_class_types[] = {"struct_declaration","enum_declaration","union_declaration",NULL};
...
static const char* zig_branch_types[] = {"if_statement","for_statement","while_statement","switch_expression",NULL};
...
static const char* haskell_branch_types[] = {"match","guards","if","case","do","boolean",NULL};
static const char* haskell_var_types[] = {"function",NULL};

// ==================== OCAML ====================
static const char* ocaml_func_types[] = {"value_definition",NULL};
static const char* ocaml_class_types[] = {"type_definition","class_definition","module_definition",NULL};
...
static const char* objc_class_types[] = {"class_interface","class_implementation","protocol_declaration",NULL};
...
static const char* objc_branch_types[] = {"if_statement","for_statement","while_statement","switch_statement",NULL};
...
static const char* swift_class_types[] = {"class_declaration","protocol_declaration","struct_declaration","enum_declaration",NULL};
...
static const char* swift_branch_types[] = {"if_statement","guard_statement","for_statement","while_statement","switch_statement",NULL};
...
static const char* dart_class_types[] = {"class_definition","enum_declaration","mixin_declaration",NULL};
...
static const char* dart_branch_types[] = {"if_statement","for_statement","while_statement","switch_statement",NULL};
...
static const char* perl_call_types[] = {"ambiguous_function_call_expression","function_call_expression","func1op_call_expression",NULL};
static const char* perl_import_types[] = {"use_statement","require_statement",NULL};
static const char* perl_branch_types[] = {"if_statement","unless_statement","for_statement","foreach_statement","while_statement",NULL};
...
static const char* groovy_branch_types[] = {"if_statement","for_statement","while_statement","switch_statement",NULL};
...
static const char* fsharp_branch_types[] = {"if_expression","for_expression","while_expression","match_expression","elif_expression",NULL};
...
static const char* julia_branch_types[] = {"if_statement","for_statement","while_statement","try_statement",NULL};
...
static const char* vim_branch_types[] = {"if_statement","for_statement","while_statement","try_statement",NULL};
...
static const char* fortran_branch_types[] = {"if_statement","do_loop_statement","where_statement","select_case_statement",NULL};
...
static const char* cobol_branch_types[] = {"if_statement","evaluate_statement","perform_statement",NULL};
...
static const char* verilog_class_types[] = {"module_declaration","class_declaration","interface_declaration",NULL};
...
static const char* verilog_branch_types[] = {"conditional_statement","case_statement","loop_statement",NULL};
...
// ==================== GRAPHQL ====================
static const char* graphql_class_types[] = {"object_type_definition","input_object_type_definition","enum_type_definition","interface_type_definition","union_type_definition","scalar_type_definition",NULL};
...
static const CBMLangSpec lang_specs[CBM_LANG_COUNT] = {
    ...
    {CBM_LANG_PHP, php_func_types, php_class_types, empty_types, php_module_types, php_call_types,
     empty_types, empty_types, php_branch_types, php_var_types, php_assign_types,
     php_throw_types, NULL, php_decorator_types, php_env_funcs, NULL},
    ...
    // CBM_LANG_SCALA
    {CBM_LANG_SCALA, scala_func_types, scala_class_types, empty_types, scala_module_types, scala_call_types,
     scala_import_types, scala_import_types, scala_branch_types, scala_var_types, scala_assign_types,
     scala_throw_types, NULL, empty_types, scala_env_funcs, NULL},

    // CBM_LANG_KOTLIN
    {CBM_LANG_KOTLIN, kotlin_func_types, kotlin_class_types, empty_types, kotlin_module_types, kotlin_call_types,
     kotlin_import_types, kotlin_import_types, kotlin_branch_types, kotlin_var_types, kotlin_assign_types,
     kotlin_throw_types, NULL, kotlin_decorator_types, kotlin_env_funcs, NULL},

    // CBM_LANG_RUBY
    {CBM_LANG_RUBY, ruby_func_types, ruby_class_types, empty_types, ruby_module_types, ruby_call_types,
     ruby_import_types, empty_types, ruby_branch_types, ruby_var_types, ruby_assign_types,
     empty_types, NULL, empty_types, NULL, ruby_env_members},
    ...
    // CBM_LANG_ZIG
    {CBM_LANG_ZIG, zig_func_types, zig_class_types, zig_field_types, zig_module_types, zig_call_types,
     zig_import_types, empty_types, zig_branch_types, zig_var_types, zig_assign_types,
     empty_types, NULL, empty_types, zig_env_funcs, NULL},

    // CBM_LANG_ELIXIR
    {CBM_LANG_ELIXIR, elixir_func_types, empty_types, empty_types, elixir_module_types, elixir_call_types,
     elixir_import_types, empty_types, elixir_branch_types, elixir_var_types, elixir_var_types,
     empty_types, NULL, empty_types, elixir_env_funcs, NULL},

    // CBM_LANG_HASKELL
    {CBM_LANG_HASKELL, haskell_func_types, haskell_class_types, empty_types, haskell_module_types, haskell_call_types,
     haskell_import_types, empty_types, haskell_branch_types, haskell_var_types, haskell_var_types,
     empty_types, NULL, empty_types, haskell_env_funcs, NULL},

    // CBM_LANG_OCAML
    {CBM_LANG_OCAML, ocaml_func_types, ocaml_class_types, empty_types, ocaml_module_types, ocaml_call_types,
     ocaml_import_types, empty_types, ocaml_branch_types, ocaml_var_types, ocaml_var_types,
     empty_types, NULL, empty_types, ocaml_env_funcs, NULL},

    // CBM_LANG_OBJC
    {CBM_LANG_OBJC, objc_func_types, objc_class_types, objc_field_types, objc_module_types, objc_call_types,
     objc_import_types, empty_types, objc_branch_types, objc_var_types, objc_assign_types,
     empty_types, NULL, empty_types, NULL, NULL},

    // CBM_LANG_SWIFT
    {CBM_LANG_SWIFT, swift_func_types, swift_class_types, swift_field_types, swift_module_types, swift_call_types,
     swift_import_types, empty_types, swift_branch_types, swift_var_types, swift_assign_types,
     swift_throw_types, NULL, swift_decorator_types, NULL, NULL},

    // CBM_LANG_DART
    {CBM_LANG_DART, dart_func_types, dart_class_types, dart_field_types, dart_module_types, dart_call_types,
     dart_import_types, empty_types, dart_branch_types, dart_var_types, dart_assign_types,
     dart_throw_types, NULL, dart_decorator_types, NULL, NULL},
    ...
    // CBM_LANG_GROOVY
    {CBM_LANG_GROOVY, groovy_func_types, groovy_class_types, empty_types, groovy_module_types, groovy_call_types,
     groovy_import_types, empty_types, groovy_branch_types, groovy_var_types, groovy_assign_types,
     groovy_throw_types, NULL, groovy_decorator_types, NULL, NULL},

    // CBM_LANG_ERLANG
    {CBM_LANG_ERLANG, erlang_func_types, empty_types, empty_types, erlang_module_types, erlang_call_types,
    ...
    {CBM_LANG_R, r_func_types, empty_types, empty_types, r_module_types, r_call_types,
     r_import_types, empty_types, r_branch_types, r_var_types, r_var_types,
     empty_types, NULL, empty_types, r_env_funcs, NULL},
    ...
    // CBM_LANG_CLOJURE
    {CBM_LANG_CLOJURE, empty_types, empty_types, empty_types, clojure_module_types, clojure_call_types,
     empty_types, empty_types, empty_types, empty_types, empty_types,
     empty_types, NULL, empty_types, NULL, NULL},

    // CBM_LANG_FSHARP
    {CBM_LANG_FSHARP, fsharp_func_types, fsharp_class_types, empty_types, fsharp_module_types, fsharp_call_types,
     fsharp_import_types, empty_types, fsharp_branch_types, fsharp_var_types, fsharp_var_types,
     empty_types, NULL, empty_types, fsharp_env_funcs, NULL},

    // CBM_LANG_JULIA
    {CBM_LANG_JULIA, julia_func_types, julia_class_types, empty_types, julia_module_types, julia_call_types,
     julia_import_types, empty_types, julia_branch_types, julia_var_types, julia_assign_types,
     julia_throw_types, NULL, empty_types, julia_env_funcs, NULL},

    // CBM_LANG_VIMSCRIPT
    {CBM_LANG_VIMSCRIPT, vim_func_types, empty_types, empty_types, vim_module_types, vim_call_types,
     empty_types, empty_types, vim_branch_types, vim_var_types, vim_var_types,
     empty_types, NULL, empty_types, NULL, NULL},
    ...
    {CBM_LANG_ELM, elm_func_types, elm_class_types, empty_types, elm_module_types, elm_call_types,
     elm_import_types, empty_types, elm_branch_types, empty_types, empty_types,
     empty_types, NULL, empty_types, NULL, NULL},

    // CBM_LANG_FORTRAN
    {CBM_LANG_FORTRAN, fortran_func_types, fortran_class_types, empty_types, fortran_module_types, fortran_call_types,
     fortran_import_types, empty_types, fortran_branch_types, fortran_var_types, fortran_assign_types,
     empty_types, NULL, empty_types, fortran_env_funcs, NULL},
    ...
    // CBM_LANG_COBOL
    {CBM_LANG_COBOL, cobol_func_types, empty_types, empty_types, cobol_module_types, cobol_call_types,
     empty_types, empty_types, cobol_branch_types, cobol_var_types, empty_types,
     empty_types, NULL, empty_types, NULL, NULL},

    // CBM_LANG_VERILOG
    {CBM_LANG_VERILOG, verilog_func_types, verilog_class_types, empty_types, verilog_module_types, verilog_call_types,
     empty_types, empty_types, verilog_branch_types, verilog_var_types, verilog_assign_types,
     empty_types, NULL, empty_types, NULL, NULL},

    // CBM_LANG_EMACSLISP
    {CBM_LANG_EMACSLISP, elisp_func_types, empty_types, empty_types, elisp_module_types, elisp_call_types,
     empty_types, empty_types, empty_types, empty_types, empty_types,
     empty_types, NULL, empty_types, NULL, NULL},
    ...
    // CBM_LANG_MESON
    {CBM_LANG_MESON, meson_func_types, empty_types, empty_types, meson_module_types, meson_call_types,
     empty_types, empty_types, meson_branch_types, meson_var_types, meson_var_types,
     empty_types, NULL, empty_types, NULL, NULL},
...
const TSLanguage* cbm_ts_language(CBMLanguage lang) {
    switch (lang) {
        ...
        case CBM_LANG_CSHARP:     return tree_sitter_c_sharp();
        case CBM_LANG_PHP:        return tree_sitter_php_only();
        case CBM_LANG_LUA:        return tree_sitter_lua();
        case CBM_LANG_SCALA:      return tree_sitter_scala();
        case CBM_LANG_KOTLIN:     return tree_sitter_kotlin();
        case CBM_LANG_RUBY:       return tree_sitter_ruby();
        case CBM_LANG_C:          return tree_sitter_c();
        case CBM_LANG_BASH:       return tree_sitter_bash();
        case CBM_LANG_ZIG:        return tree_sitter_zig();
        case CBM_LANG_ELIXIR:     return tree_sitter_elixir();
        case CBM_LANG_HASKELL:    return tree_sitter_haskell();
        case CBM_LANG_OCAML:      return tree_sitter_ocaml();
        case CBM_LANG_OBJC:       return tree_sitter_objc();
        case CBM_LANG_SWIFT:      return tree_sitter_swift();
        case CBM_LANG_DART:       return tree_sitter_dart();
        case CBM_LANG_PERL:       return tree_sitter_perl();
        case CBM_LANG_GROOVY:     return tree_sitter_groovy();
        case CBM_LANG_ERLANG:     return tree_sitter_erlang();
        case CBM_LANG_R:          return tree_sitter_r();
        ...
        case CBM_LANG_FSHARP:     return tree_sitter_fsharp();
        case CBM_LANG_JULIA:      return tree_sitter_julia();
        case CBM_LANG_VIMSCRIPT:  return tree_sitter_vim();
        case CBM_LANG_NIX:        return tree_sitter_nix();
        case CBM_LANG_COMMONLISP: return tree_sitter_commonlisp();
        case CBM_LANG_ELM:        return tree_sitter_elm();
        case CBM_LANG_FORTRAN:    return tree_sitter_fortran();
        case CBM_LANG_CUDA:       return tree_sitter_cuda();
        case CBM_LANG_COBOL:      return tree_sitter_COBOL();
        case CBM_LANG_VERILOG:    return tree_sitter_verilog();
        case CBM_LANG_EMACSLISP:  return tree_sitter_elisp();
